...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/PLANE_aug.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'runs/train/v0.1/weights/best.pt', help='model.pt path(s)')
